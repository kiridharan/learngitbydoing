...
export const modules: EnhancedModule[] = [
  ...
  },
  {
    ...
    description: "Master Git branches and merge strategies",
    lessons: [
      {
        id: "2-1",
        title: "Understanding Branches",
        description: "What are branches and how to use them effectively",
      ...
      },
      {
        ...
        description: "Learn different merge strategies",
        content: "Merge branches with fast-forward and 3-way merge...",
        completed: false,
        duration: 14,
        type: 'static',
      },
      {
        ...
        content: "Handle conflicts when merging branches...",
        completed: false,
        duration: 18,
        type: 'static',
      },
    ...
    lessons: [
      {
        id: "3-1",
        title: "Remote Basics",
        description: "Understanding remote repositories",
        content: "Learn about origin, upstream, and remote tracking...",
        completed: false,
        duration: 10,
        type: 'static',
      },
      {
        ...
        content: "Master push, pull, and fetch operations...",
        completed: false,
        duration: 12,
        type: 'static',
      },
  ...
  },
  {
    ...
    description: "Learn advanced Git patterns and workflows",
    lessons: [
      {
        id: "4-1",
        title: "Rebase vs Merge",
        description: "Understanding rebase and when to use it",
        content: "Rebase for linear history or merge for preservation...",
        completed: false,
        duration: 16,
        type: 'static',
      },
      {
        ...
        description: "Selective commit management",
        content: "Pick specific commits or undo commits...",
        completed: false,
        duration: 12,
        type: 'static',
      },
      {
        id: "4-3",
        title: "Stashing & Reflog",
        description: "Temporary storage and history recovery",
        content: "Save work in progress and recover lost commits...",
        completed: false,
        duration: 14,
        type: 'static',
      },
